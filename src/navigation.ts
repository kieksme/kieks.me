...
export const footerData = {
  ...
  socialLinks: [
    ...
    */
    ...
    { ariaLabel: 'Github', icon: 'tabler:brand-github', href: 'https://github.com/nullzueins' },
  ],
  footNote: `
    Template made by <a class="text-blue-600 underline dark:text-muted" href="https://onwidget.com/"> onWidget</a>
  `,
};
